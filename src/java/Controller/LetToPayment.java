 ...
 * @author Quyền
 */
@WebServlet(name = "LetToPayment", urlPatterns = {"/LetToPayment"})
public class LetToPayment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("Payment", cartItems);
            request.setAttribute("product", products);
            request.setAttribute("shopOwner", shopOwners);
