<%-- 
    Document   : NewProductPage
    Created on : Nov 5, 2024, 12:26:35 AM
    Author     : Quyền
--%>
            ...
            <div class="navigation_first">
                ...
                <div class="Search_navigation">
                    <form action="MainController" method="Get">
                        ...
                        <input type="hidden" value="1" name="txtStype"/>
            ...
            <div class="content_search">
                <div class="search_Gender">
                    ...
                    <div id="genreList" class="genre-list" style="display: none;"> 
                        <a href="MainController?action=SearchGender&txtcategory=Toán học&txtQRent=0&txtQSell=1&txtStype=1">Toán học</a>                                        
                        <a href="MainController?action=SearchGender&txtcategory=Giải đố&txtQRent=0&txtQSell=1&txtStype=1">Giải đố</a><br>                                      
                        <a href="MainController?action=SearchGender&txtcategory=Ngôn ngữ&txtQRent=0&txtQSell=1&txtStype=1">Ngôn ngữ</a>
                        <a href="MainController?action=SearchGender&txtcategory=Kĩ thuật&txtQRent=0&txtQSell=1&txtStype=1">Kĩ thuật</a><br>  
                        <a href="MainController?action=SearchGender&txtcategory=Khoa học&txtQRent=0&txtQSell=1&txtStype=1">Khoa học</a>
                        <a href="MainController?action=SearchGender&txtcategory=Nghệ thuật&txtQRent=0&txtQSell=1&txtStype=1">Nghệ thuật</a><br>
                        <a href="MainController?action=SearchGender&txtcategory=Xếp hình&txtQRent=0&txtQSell=1&txtStype=1">Xếp hình</a>
                        <a href="MainController?action=SearchGender&txtcategory=Mô phỏng&txtQRent=0&txtQSell=1&txtStype=1">Mô phỏng</a><br>
                        <a href="MainController?action=SearchGender&txtcategory=Thiên văn&txtQRent=0&txtQSell=1&txtStype=1">Thiên văn</a>
                        <a href="MainController?action=SearchGender&txtcategory=Địa lý&txtQRent=0&txtQSell=1&txtStype=1">Địa lý</a><br>
                        <a href="MainController?action=SearchGender&txtcategory=Thể chất&txtQRent=0&txtQSell=1&txtStype=1">Thể chất</a>
                    </div>
                </div>
                ...
                <div class="search_Age">
                    ...
                    <div id="AgeList" class="Age-list" style="display: none;"> 
                        <a href="MainController?action=SearchAge&txtMinAge=1&txtMaxAge=3&txtQRent=0&txtQSell=1&txtStype=1">1-3 tuổi</a>
                        <a href="MainController?action=SearchAge&txtMinAge=3&txtMaxAge=5&txtQRent=0&txtQSell=1&txtStype=1">3-5 tuổi</a><br>
                        <a href="MainController?action=SearchAge&txtMinAge=5&txtMaxAge=7&txtQRent=0&txtQSell=1&txtStype=1">5-7 tuổi</a>
                        <a href="MainController?action=SearchAge&txtMinAge=7&txtMaxAge=10&txtQRent=0&txtQSell=1&txtStype=1">7-10 tuổi</a>
                    </div>
                </div>
            </div>     
        </div>
            ...
            <div class="Show_product">
                <c:forEach var="saleList" items="${saleList}">
                    <div class="product-box">
                        <a href="MainController?txtPID=${saleList.pid}&action=viewProduct">
                            <img src="${saleList.image}"/>
                            <p>${saleList.name}</p>
                            <a>Giá: <fmt:formatNumber value="${saleList.price}" pattern="#,###"></fmt:formatNumber> đ </a>
                        </a>
                    </div>
                </c:forEach>                       
            </div>   
